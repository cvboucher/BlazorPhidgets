...
(function (global, factory) {
	...
	exports.DecelerationType = void 0;
	...
	})(exports.DecelerationType || (exports.DecelerationType = {}));
	/**
	...
	class PhidgetChannel extends Phidget {
	  ...
	  getHubPortCount() {
	    ...
	    if (this.deviceClass !== exports.DeviceClass.VINT && this.deviceClass !== exports.DeviceClass.HUB) throw new PhidgetError(exports.ErrorCode.WRONG_DEVICE);
	    ...
	    return new promise((resolve, reject) => {
	      ...
	      try {
	        ...
	        this._ws.onclose = () => {
	          ...
	          if (!hasCompleted) {
	            hasCompleted = true;
	            reject(new PhidgetError(exports.ErrorCode.CONNECTION_RESET, "Socket closed"));
	          }
	        };
	        ...
	        this._ws.onmessage = event => {
	          try {
	            ...
	            const perr = new PhidgetError(exports.ErrorCode.UNEXPECTED, msg, e);
	...
	class Stepper extends StepperBase {
	  ...
	  getMinPosition() {
	    ...
	    if (this.data.minPosition === 9223372036854776000) throw new PhidgetError(exports.ErrorCode.UNKNOWN_VALUE);
	  ...
	  getMaxPosition() {
	    ...
	    if (this.data.maxPosition === 9223372036854776000) throw new PhidgetError(exports.ErrorCode.UNKNOWN_VALUE);
	  ...
	  getTargetPosition() {
	    ...
	    if (this.data.targetPosition === 9223372036854776000) throw new PhidgetError(exports.ErrorCode.UNKNOWN_VALUE);
	...
	class Hub extends HubBase {
	  async getPortMode(port) {
	    ...
	    if (port < 0 || port > this.hubPortCount - 1) throw new PhidgetError(exports.ErrorCode.INVALID_ARGUMENT, "Value must be in range: 0 - " + (this.hubPortCount - 1) + ".");
	  ...
	  getPortMaxSpeed(port) {
	    ...
	    if (portMaxSpeed == undefined) throw new PhidgetError(exports.ErrorCode.UNKNOWN_VALUE);
	    return portMaxSpeed;
	  }
	  ...
	  getPortSupportsAutoSetSpeed(port) {
	    ...
	    if (portSuppAutoSetSpeed == undefined) throw new PhidgetError(exports.ErrorCode.UNKNOWN_VALUE);
	  ...
	  getPortSupportsSetSpeed(port) {
	    ...
	    if (portSuppSetSpeed == undefined) throw new PhidgetError(exports.ErrorCode.UNKNOWN_VALUE);
...
//# sourceMappingURL=phidget22.net.js.map
